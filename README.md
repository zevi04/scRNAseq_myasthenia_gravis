...
2. How does AChR-positive MG differ transcriptionally from healthy controls?
3. How does pre-treatment seronegative MG differ from healthy controls?
4. What changes occur between seronegative MG pre- and post-treatment states?
5. Which cell types show the greatest transcriptional perturbation?
6. Which populations show predominantly upward or downward DEG patterns?
...
9. Is there significant transcript-level evidence involving AChR receptor-subunit genes or `MUSK`?
...
See [`FIGURES/README.md`](FIGURES/README.md) and [`RESULTS/README.md`](RESULTS/README.md) for organization details.
...
For the exact execution order, see [`SCRIPTS/README.md`](SCRIPTS/README.md).
...
| Document | Purpose |
| --- | --- |
| [`PROJECT.md`](PROJECT.md) | Scientific scope, objectives and analytical design |
| [`JOURNAL.md`](JOURNAL.md) | Chronological research record and troubleshooting |
...
| [`SCRIPTS/README.md`](SCRIPTS/README.md) | Script order, purpose and execution notes |
